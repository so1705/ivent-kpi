...
// Restore the getAIAdvice function properly
const aiAdviceCode = `const getAIAdvice = (stats, isPersonal) => {
...
// Replace the entire getAIAdvice function
content = content.replace(/const getAIAdvice = \(stats, isPersonal\) => \{[\s\S]+?\r?\n\};/, aiAdviceCode);

fs.writeFileSync(path, content, 'utf8');
console.log("getAIAdvice restoration complete");
