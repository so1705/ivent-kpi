...
// ==========================================
// 2. ç¹§E¢ç¹§E¤ç¹§E³ç¹ï½³ç¹ãEãƒ»ç¹§E¿ (Data)
// ==========================================
const I = {
...
const BREAKDOWN_LABELS = {
  noAnswer: 'è³æ¦Šæƒ ',
  receptionRefusal: 'èœ¿å¶ºE»ä¿¶æ‹ èœ·E¦',
  picAbsent: 'è«¡ãƒ»E½è¬ï½¸æ¦Šæƒ ',
  picConnected: 'è­›ï½¬è Eºè¬—ï½¥é‚¯ãƒ»,
  requests: 'é›‰ãEä¾­é¨¾âˆ½E»ãƒ»,
  appts: 'ç¹§E¢ç¹ãE,
  outOfTarget: 'èŸE½¾é›ï½¡èŸãE
};

// ==========================================
// 3. UIé©›ï½¨èœ©âˆšã•ç¹ï½³ç¹æ˜´ãƒ»ç¹é˜ªÎ¦ç¹ãE(Atomic Components)
// ==========================================
...
const getAIAdvice = (stats, isPersonal) => {
  ...
  if (calls === 0) return "ç¹ãEãƒ»ç¹§E¿ç¸ºæ¢§æ‚´é—¢ãƒ»E©é˜ªã€’ç¸ºå¶Â€ã‚Eˆªç¸ºå£¹ãƒ»è­«E¶é«®E»ç¹§E¢ç¹§E¯ç¹§E·ç¹ï½§ç¹ï½³ç¹§å¸å¹•èŸ‹ä¹ï¼ ç¸²âˆšãEç¹ï½¼ç¹§E¹ç¹ï½©ç¹§E¤ç¹ï½³ç¹§å‰E½½æ‡ˆãEç¸ºåŠ±âˆªç¸ºåŠ±EE¸ºãƒ»Â€ãƒ»;
  ...
  if (isPersonal) {
    if (connectRate < 0.15) {
      categories.push({
        obs: "è­›ï½¬è Eºè¬—ï½¥é‚¯å¤‚ç´«ç¸ºå¾¡E½æ‰‹ï½¿E·ç¸ºåŠ±â€»ç¸ºãƒ»âˆªç¸ºå¶Â€ã‚Eœç¹§E¹ç¹åŒ»ãƒ»é­E½®è ï½¦ç¸ºåŒºå‡¾é«¢ç˜ï½¸E¯ç¸ºE®è³å ºE¸Â€é–¾E´ç¸ºæªæ¡ç¹§ä¸Šï½Œç¸ºE¾ç¸ºå¶Â€ãƒ»,
        strategy: "ç¹§E¢ç¹åŠ±ÎŸç¹ï½¼ç¹âEã¡ç¹§E¤ç¹æº˜Î¦ç¹§E°ç¸ºE®ç¹§E·ç¹è¼”ãƒ¨",
        action: "ç¹§E¿ç¹ï½¼ç¹§E²ç¹ãEãƒ¨è®Œï½­é€¡å¾Œâ€²è­›Â€ç¹§ã‚‹å´•éš§E±ç¸ºE«èœE½ºç¹§ãƒ»â˜E¸ºãƒ»å‡¾é«¢ç˜ï½¸E¯ãƒ»äº•ï½¾å…·E¼å¤ï½£E²é¬Ÿæº˜âEç¹§ãƒ»4-16è­ã‚…Â€ETç¸ºEªç¹§ãƒ»0-11è­ã‚‘E¼å³¨âˆˆè­«E¶é«®E»ç¹§å¸å¯”è³E­ç¸ºè¼”â—‹ç¸ºE¦ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»
      });
      categories.push({
        obs: "èœ¿å¶ºE»å€¥ã€’ç¸ºE®ç¹æ‚¶ÎŸç¹ãEã‘ç¸ºæ‚Ÿï½¤å£¹Eç¹§åŒ»â‰§ç¸ºE§ç¸ºå¶Â€ãƒ»,
        strategy: "ç¹è¼”ÎŸç¹ï½³ç¹è‚²Eªâˆ«E½E´éš§E±è±•è¼”ãEè¬¾E¹èŸãE,
        action: "ç¸²å¾ŒÂ€ãƒ»Â€ãƒ»E§åE½¼äº¥Â€å€¶EºEºèœ·æ¾E¼å³¨Â€é˜ªE’è¬–ãEéŒç¸ºå¶E‹ç¸²âˆšâ‰ ç¹§ä¹ï¼ç¸ºE¯é€•ï½¨è‰ï½¶ç¹§åµÂ€ç‘šï½³ãƒ»ä¾­ç¸ºE®è‰ï½¶ç¸²é˜ªâ†’ç¹§E·ç¹ï½³ç¹åŠ±Îç¸ºE«è¨æ˜´âˆ´ç¹§ä¹ï¼E¸ºE¨ç¸ºE§ç¸²âˆå¥³è‰å€¬Â€å¤â„ƒé‚EEE’é¬®å€¥Eç¸ºE¾ç¸ºåŠ±EE¸ºãƒ»Â€ãƒ»
      });
    }

    if (apptRate < 0.05) {
      categories.push({
        obs: "è­›ï½¬è Eºè¬—ï½¥é‚¯å£¹ãƒ»ç¸ºE§ç¸ºé˜ªâ€»ç¸ºãƒ»âˆªç¸ºå¶â€²ç¸²âˆšã„ç¹æ˜´âˆˆç¸ºE®éœE½¢è¬ å¸™â€²è ‘ï½±ç¸ºãƒ»ã€’ç¸ºå¶Â€ãƒ»,
        strategy: "èœ€å¸ï¿½E­30é˜åEãƒ»ç¹è¼”ãƒ£ç¹§E¯è ‘ï½·è›¹ãƒ»,
        action: "é€¶E¸è¬E¹â€²ç¸²ç‘šãEè›»ãƒ»â†“é«¢E¢è«ã‚E€²ç¸ºã‚E½‹ç¸²é˜ªâ†’è«¤æ˜´âˆ´ç¹§ä¹Î“ç¹ï½ªç¹ãEãƒ¨ãƒ»äº•ï½»ä¹Ÿï½¤E¾è å€¶E¾ä¹âEç¸ºE©ãƒ»å³¨E’ç¸²âˆµç£E‚¯å¤‚å³©è •å¾ŒãE15é˜å‰ƒE»E¥èœ€ãƒ»â†“é€¶å¸™ï½ŠéœE¼ç¹§è–™ã€’ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»
      });
      categories.push({
        obs: "ç¹é˜ªã‘ç¹§E¹ç¹åŒ»ãE¹§E¯ç¹§E·ç¹ï½§ç¹ï½³ç¸ºE®è¬ åE½¤Eºç¸ºæ¢§å° è­ï½§ç¸ºE§ç¸ºå¶Â€ãƒ»,
        strategy: "ç¹§E¯ç¹ï½­ç¹ï½¼ç¹§Eºç¹å³¨ãƒ»ç¹§E¯ç¹§E¨ç¹§E¹ç¹âEÎ™ç¹ï½³ç¸ºE®è±¢E»é€•ï½¨",
        action: "ç¸²å¾Œï¼ç¸ºE¤ç¸ºç‘šæEç¸ºãƒ»ã€’ç¸ºå¶Â°ãƒ»æº˜Â€é˜ªã€’ç¸ºE¯ç¸ºEªç¸ºä¸ŠÂ€æªâEè­–æ‡Šãƒ»14è­ã‚…Â°è±Œï½´è­–æ‡Šãƒ»11è­ã‚…â†‘ç¹§å³¨â†ç¸ºE¡ç¹§å³¨â€²é©›ï½½èœ·éƒæEç¸ºãƒ»ã€’ç¸ºå¶Â°ãƒ»æº˜Â€é˜ªâ†’é©•ï½¸è¬šæ«ã„ç¹§å‘ˆç½²é‰ï½ºç¸ºåŠ±â€»ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»
      });
    }

    if (requestRate > 0.15 && apptRate < 0.05) {
      categories.push({
        obs: "ç¸²ç‘šï½³ãƒ»ä¾­é¨¾âˆ½E»å€¥Â€é˜ªã€’é¨¾ãƒ»E¡ç¹§å³¨EŒç¸ºE¦ç¸ºãƒ»E‹ç¹§E±ç¹ï½¼ç¹§E¹ç¸ºæ¢§æ·µéš•ä¹ï¼E¹§å¾Œâˆªç¸ºå¶Â€ãƒ»,
        strategy: "é›‰ãEä¾­é¨¾âˆ½E»å€¥E’ç¹§E¢ç¹æ˜´ãƒ»ç¹§E¹ç¹ãEãƒ£ç¹åŠ±â†“ç¸ºå¶EE,
        action: "ç¸²ç‘šï½³ãƒ»ä¾­ç¹§å¸Â€âˆšï½Šç¸ºE¾ç¸ºå¶ãƒ»ç¸ºE§ç¸²âˆšâ—ç¸ºE®èœ€ãƒ»E®E¹ç¹§ãƒ»è›»ãƒ»â–¡ç¸ºé¡Œï½§E£éš±E¬ç¸ºè¼”â—‹ç¸ºE¦ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²é˜ªâ†’ç¸ºãƒ»â‰§è±¬âˆšï½Œç¸ºE§ç¸²âˆ¬E³ãƒ»ä¾­é¨¾âˆ½E»å€¥â†’èœ·æ¢§å‡¾ç¸ºE«ç¹§E¢ç¹æ˜´E’é’Eºè³å£¹EE¸ºå¸™âˆªç¸ºåŠ±EE¸ºãƒ»Â€ãƒ»
      });
    }

    if (totalCvr > 0.03) {
      categories.push({
        obs: "è®Œï½µç¹§âˆšâ€»é¬®å€¥Eç¹ä»£ãƒµç¹§E©ç¹ï½¼ç¹æ§­Î¦ç¹§E¹ç¸ºE§ç¸ºå¶Â€ã‚‰æ¨Ÿè¨E¨ç¸ºE®ç¹åŒ»ãƒ»ç¹§E¯ç¹§E¹ç¹§E­ç¹ï½«ç¸ºE¯è³æ¢§ãƒ»ç¸ºè¼”ï½Œç¸ºE¦ç¸ºãƒ»âˆªç¸ºå¶Â€ãƒ»,
        strategy: "è¬Œä»™ç²¥ç¹ä»£ã¡ç¹ï½¼ç¹ï½³ç¸ºE®ç¹ç¿«Îç¹ãEãšè›¹ãƒ»,
        action: "è‚ï½½éš±E¿ç¸ºEªéš•âEå±ãEåŒ»ã›ç¹§E¯ç¹ï½ªç¹åŠ±ãƒ¨ç¸²âˆšãƒ¨ç¹ï½¼ç¹ï½³ç¸²âˆï½¯E¾é›ï½¡ç¹ï½ªç¹§E¹ç¹èŒ¨E¼å³¨E’ç¹âEãƒ»ç¹ï¿½ç¸ºE«èœˆï½±è­›å³¨E ç¸²âˆãEè´è–™ãEè ç©‚ï½¸ç¿«E¡ç¸ºE«é›‹ï½¢è¿ªE®ç¸ºåŠ±â€»ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»
      });
    }

    if (categories.length === 0) {
      categories.push({
        obs: "è³ç‰™ï½®å£¹E ç¸ºæ»“è€³é˜ï½»ç¸ºE§ç¸ºå¶Â€ã‚E½¤E§ç¸ºé˜ªâ†‘ç¹æ‡Šãƒ¨ç¹ï½«ç¹é˜ªãƒ£ç¹§E¯ç¸ºE¯éš•ä¹ï½‰ç¹§å¾Œâˆªç¸ºå¸™ï½“ç¸²ãƒ»,
        strategy: "è •ï½®é‚ï½°ç¸ºEªç¹åŒ»ãƒ»ç¹ï½³ãƒ»ãƒ»ãƒ»ç¹ç¿«ãƒ»ç¸ºE®éš±E¿è¬¨E´",
        action: "é–¾Eªè›»ãƒ»ãƒ»éª­E²é«»E³ç¹§å®šâ—‡ç¸ºå´ï½¿æ–ï¼ ç¸²âˆ«å¶Œè¬E¹ãEèŸä¹ï½‹ç¹§E¹ç¹æ–ãƒ»ç¹ä¼šï½¼åŒ»ãƒ»ç¹ï½¼ç¹§E·ç¹ï½³ç¹§E°ãƒ»å³¨â†“èœ·åŒ»Eç¸ºå¸™ï½‹é‚±E´é„™åEE’ç¸ºåŠ±â€»ç¸²âˆšï¼E¹§å³¨â†“éš•EªèŸEEEºE¦ç¹§å¸ï½«å€¥Eç¸ºE¾ç¸ºåŠ±EE¸ºãƒ»Â€ãƒ»
      });
      categories.push({
        obs: "é€¹Â€è³æº˜âEè¬¨E°èŸEŠ±E’é¨é˜ªâˆ©è³ç¿«E¡ç¸ºE¦ç¸ºãƒ»âˆªç¸ºå¶Â€ãƒ»,
        strategy: "é«®ãƒ»E¸E­èœ‰å¸™ãEè±•ï½¢ç¸ºE®ç¹§E³ç¹ï½³ç¹åŒ»ÎŸç¹ï½¼ç¹ï½«",
        action: "50è›»ãƒ»æ¥”é«®E»ç¹ï½»10è›»ãƒ»E¼ç¬¬ãƒ»ç¸ºE®ç¹§Eµç¹§E¤ç¹§E¯ç¹ï½«ç¹§è²ï½¾E¹è è¼”ï¼ ç¸²ãƒ»E«å€¥Eç¹ä»£ãƒµç¹§E©ç¹ï½¼ç¹æ§­Î¦ç¹§E¹ç¹§å¸èè­ã‚‹ä¿£è¬–âˆ«E¶å£¹EE¸ºå¸™ï½‹èŸ¾E¥èŸï½«ç¹§åµE ç¸ºE¦ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»
      });
    }
  } else {
    if (connectRate < 0.20) {
      categories.push({
        obs: "ç¹âEãƒ»ç¹ï¿½èœˆï½¨è´è–™ãEè¬—ï½¥é‚¯å¤‚ç´«ç¸ºå¾¡E½æƒ¹E¸ä¹ï¼ ç¸ºE¦ç¸ºãƒ»âˆªç¸ºå¶Â€ã‚Eœç¹§E¹ç¹åŒ»ãƒ»è­«E¯è²‚ãEâ€²é– ãƒ»âˆ´ç¹§å³¨EŒç¸ºE¾ç¸ºå¶Â€ãƒ»,
        strategy: "ç¹ï½ªç¹§E¹ç¹åŒ»ãƒ»èœ€é˜ªãç¹§E°ç¹ï½¡ç¹ï½³ç¹äº¥å–§",
        action: "è­›ï½ªè­«E¶é«®E»ç¹ï½ªç¹§E¹ç¹åŒ»ãƒ»é™¬æ‡·ãƒ»ç¸²âˆšâˆªç¸ºæº˜ãEç¹§E¢ç¹åŠ±ÎŸç¹ï½¼ç¹âEE¯E¾é›ï½¡è®Œï½­é€¡å¾ŒãEèœE½ªèœˆç£¯E½ãƒ»E½é˜ªE’èœŠE³è ï½§ç¸ºE«éš•ç‹—å³©ç¸ºåŠ±â€»ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»
      });
    } else if (apptRate < 0.07) {
      categories.push({
        obs: "ç¹âEãƒ»ç¹ï¿½èœˆï½¨è´è–™ã€’ç¹§E¢ç¹æ™‰ä½è •åŠ±â†“é—E¦è¬Œï½¦ç¸ºåŠ±â€»ç¸ºãƒ»âˆªç¸ºå¶Â€ãƒ»,
        strategy: "ç¹åŒ»ãƒ£ç¹åŠ±ãƒ»ç¹ï½¬ç¹§E¤ç¹ï½¤ç¹ï½¼ç¸ºE®ç¹å¼±ãˆç¹ä¸Šãˆè»æš®å¹E,
        action: "è¬ŒåƒE¸E¾è³è´‹ï½½å´Â€ãƒ»ãƒ»éª­E²é«»E³ç¹§è²ãEèœ©E¡ç¸ºE§é–¨æ§­E¥ç¸²å¾ŒÎŸç¹ï½¼ç¹åŠ±Îç¹ï½»ç¹è¼”ã…ç¹ï½¼ç¹å³¨ãƒ°ç¹ãEã‘è¨å£¹Â€é˜ªE’è³æ»“å‘½ç¸ºåŠ±Â€âˆ¬æ†¶ç¸ºãƒ»ãƒµç¹ï½¬ç¹ï½¼ç¹§Eºç¹§è²å‰è ï½§ç¸ºE«é€¶åŠ±E“ç¸ºE§ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»
      });
    } else {
      categories.push({
        obs: "ç¹âEãƒ»ç¹ï¿½èœˆï½¨è´è–™ã€’é¬®å€¥Eé€•æº½è‚E«¤E§ç¹§å ¤E¶E­è¬–âEã€’ç¸ºé˜ªâ€»ç¸ºãƒ»âˆªç¸ºå¶Â€ãƒ»,
        strategy: "ç¹ï½¢ç¹âEãƒ»ç¹ï½¼ç¹§E·ç¹ï½§ç¹ï½³é‚¯E­è¬–âEâ†’è¿ºE°è EEç´›è›¯ãƒ»,
        action: "è›Ÿä¹Â€ãƒ»ãƒ»è¬ŒåEæ£¡ç¹§å ¤E§E°ç¸ºäº¥ç²‹ç¸ºãƒ»Â€âˆšãEç¹§E¸ç¹ãEãE¹æ‚¶â†‘é«®E°è—ï½²è±ŒåŠ±E’é‚¯E­è¬–âEâ˜E¹§ä¹ï¼E¸ºE¨ç¸ºE§ç¸²ãƒ»Â€E±è­›ï½«ç¸ºE¾ç¸ºE§ç¸ºE®ç¹ï½©ç¹§E¹ç¹åŒ»ã›ç¹ä»£ãƒ»ç¹åŒ»E’ç¸ºä¹ï¿ ç¸ºE¾ç¸ºåŠ±EE¸ºãƒ»Â€ãƒ»
      });
    }
  }
  ...
  return (
    <div className={`p-8 rounded-[2rem] border border-slate-100 bg-white flex flex-col gap-6 shadow-sm relative overflow-hidden group transition-all hover:shadow-xl`}>
       <div className="flex items-center justify-between">
          ...
          <span className={`text-[10px] font-black px-3 py-1 rounded-full ${isOk ? 'bg-emerald-100 text-emerald-600' : 'bg-blue-50 text-blue-600'}`}>{isOk ? 'é©•ç–²ãƒ»è²‚åŒ»âˆ©' : 'é€¶E®è®“å’EE¬ŒèEâˆE}</span>
       </div>
...
const CustomChart = ({ data, color, type = 'area' }) => {
  if (!data || data.length === 0) return <div className="h-full flex items-center justify-center text-slate-300 font-bold text-xs uppercase tracking-widest">ç¹ãEãƒ»ç¹§E¿ç¸ºå¾Œâ‰ ç¹§ç¿«âˆªç¸ºå¸™ï½E/div>;
  ...
  return (
    <div className="w-full h-full relative flex flex-col pl-4 pb-2">
      <div className="absolute -left-2 top-1/2 -translate-y-1/2 -rotate-90 text-[10px] font-bold text-slate-400 tracking-widest">è‰ï½¶è¬¨E°</div>
      ...
      <div className="text-center text-[10px] font-bold text-slate-400 tracking-widest mt-1">è­Œï½¥è‰ãE/div>
    </div>
  );
};
       ...
       <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 border-b border-slate-100 pb-10">
          <div className="space-y-3">
             ...
             <div className="flex items-center gap-4 text-xs font-bold text-slate-400">
                <span className="flex items-center gap-2"><div className="w-2 h-2 bg-emerald-500 rounded-full"></div> è±E½£èŸ¶E¸éï½¼èœ’å ºE¸E­</span>
                <span className="w-px h-3 bg-slate-200"></span>
                <span>é©•å¥éœ§è­›æ»E¿£èœ€ãƒ»/span>
             </div>
          </div>
          <div className="flex bg-slate-200 p-1 rounded-2xl">
             <button onClick={()=>setViewMode('personal')} className={`px-8 py-3 text-xs font-bold transition-all rounded-xl ${viewMode==='personal'?'bg-white text-blue-600 shadow-sm':'text-slate-500 hover:text-slate-900'}`}>{currentUserEmail === ADMIN_EMAIL ? 'è›Ÿå€¶EºEºé‚¨E±éšªãƒ» : 'ç¹æ§­ãE³æº½E¸E¾'}</button>
             <button onClick={()=>setViewMode('team')} className={`px-8 py-3 text-xs font-bold transition-all rounded-xl ${viewMode==='team'?'bg-white text-blue-600 shadow-sm':'text-slate-500 hover:text-slate-900'}`}>èœˆï½¨è´æºæ¬ è®“ãE/button>
          </div>
       </div>
       ...
       {viewMode === 'personal' ? (
                  <div className="space-y-10">
                     <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-1 space-y-6">
                           <h3 className="text-sm font-black text-slate-800 flex items-center gap-2">
                             <div className="w-1.5 h-4 bg-blue-600 rounded-full"></div> è›Ÿå€¶EºEºé€¶E®è®“ãE(é–¾Eªèœæš®ãƒ»è›»ãƒ»
                           </h3>
                           <div className="p-8 bg-white border-2 border-slate-900 rounded-[2rem] shadow-sm space-y-6">
                              <div className="flex justify-between items-center">
                                 <div className="flex items-center gap-2">
                                    <span className="text-xs font-bold text-slate-400">è³Â€è •ç‹—å²¼è®“ãE/ è Eº</span>
                                 ...
                                 <span className="text-2xl font-black text-slate-900">{(memberStats.find(m=>m.email===currentUserEmail)?.uniformGoal || 0)} <span className="text-xs">è‰ï½¶</span></span>
                              </div>
                              <MetricBar label="é©•ç–²ãƒ»é‚EE val={myTotals.appts} tgt={memberStats.find(m=>m.email===currentUserEmail)?.uniformGoal || 1} />
                           </div>
                        </div>

                        <div className="lg:col-span-1 space-y-6">
                           <h3 className="text-sm font-black text-slate-800 flex items-center gap-2">
                             <div className="w-1.5 h-4 bg-emerald-500 rounded-full"></div> è‰ä¼E€E±ç¸ºE®é€¹Â€è¨E°è åŸŸï½¸E¬
                           </h3>
                           <div className="p-8 bg-emerald-900 text-white rounded-[2rem] shadow-xl relative overflow-hidden">
                              ...
                              <div className="relative z-10 space-y-4">
                                 <div className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest">ç¹ãEãƒ»ç¹§E¿ç¸ºE«è“ï½ºç¸ºE¥ç¸ºä¹—æ‚„è •ãEÂ€E¤</div>
                                 <div className="text-5xl font-black">{memberStats.find(m=>m.email===currentUserEmail)?.expectedAppts || 0}<span className="text-sm font-normal ml-2 opacity-50">è‰ï½¶</span></div>
                                 <div className="pt-4 border-t border-emerald-800 flex justify-between items-center">
                                    <span className="text-xs font-bold opacity-60">é€¶E®è®“å¶â†’ç¸ºE®èŸ¾E®è›»ãƒ»/span>
                                    <span className="text-lg font-black">
                                       ...
                                       <span className="text-xs ml-1">è‰ï½¶</span>
                                    </span>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div className="lg:col-span-1 space-y-6">
                           <h3 className="text-sm font-black text-slate-800 flex items-center gap-2">
                             <div className="w-1.5 h-4 bg-slate-300 rounded-full"></div> éï½¼èœ’æ¦ŠæŸ‘é‚EE
                           </h3>
                           <div className="p-8 bg-white border border-slate-100 rounded-[2rem] shadow-sm flex flex-col justify-between h-[180px]">
                              <div className="flex justify-between items-start">
                                 <div>
                                    <div className="text-[10px] font-bold text-slate-400 uppercase">1hç¸ºã‚E—†ç¹§ãƒ»CPH)</div>
                                    <div className="text-3xl font-black text-blue-600">{(myTotals.calls / (myTotals.hours || 1)).toFixed(1)}</div>
                                 </div>
                                 <div>
                                    <div className="text-[10px] font-bold text-slate-400 uppercase text-right">è äº¥E®å¤‚ï½¨E¼èœ’è‚´å‡¾é«¢ãƒ»/div>
                              ...
                              <div className="text-[10px] text-slate-400 font-bold leading-tight">é©•ä¸»æ‚‰è³æº½E¸E¾ç¸ºä¹ï½‰é‚‚æ€œãEç¸ºè¼”ï½Œç¸ºæ»“æ‚„è •ãEÂ€E¤ç¸ºE§ç¸ºå¶Â€ã‚‰ï½¨E¼èœ’è‚´å‡¾é«¢è–™ï½’è EŠ±EE¸ºå¶Â°ç¸²âˆæŸ‘é‚EEE’è³ç¿«E¡ç¹§ä¹ï¼E¸ºE¨ç¸ºE§é€¶E®è®“å’EE¬ŒèEâ†“éœ‘ä»£â–¼ç¸ºé˜ªâˆªç¸ºå¶Â€ãƒ»/div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="space-y-6">
                        <h3 className="text-sm font-black text-slate-800 flex items-center gap-2">
                           <div className="w-1.5 h-4 bg-blue-600 rounded-full"></div> è­›ï½¬è­Œï½¥ç¸ºE®éï½¼èœ’é˜ªãƒ§ç¹ï½¼ç¹§E¿ (GASèœ·æ¢§æ‚E
                        </h3>
                 ...
                 <div className="space-y-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                       <div className="space-y-6">
                          <h3 className="text-sm font-black text-slate-800 flex items-center gap-2">
                            <div className="w-1.5 h-4 bg-blue-600 rounded-full"></div> ç¹âEãƒ»ç¹ï¿½é€¶E®è®“ãE
                          </h3>
                          <MainMetric label="èœˆï½¨é‰ï½¾ç¹§E¢ç¹æ˜´ãE¹ï½³ç¹è‚²ä½è •ç²ç„E icon={I.Check} current={totals.weekly.appts} target={activeWeeklyGoals.appts} />
                       </div>
                       <div className="space-y-6">
                          <h3 className="text-sm font-black text-slate-800 flex items-center gap-2">
                            <div className="w-1.5 h-4 bg-slate-300 rounded-full"></div> èœˆï½¨è´ç˜æŸ‘é‚EE
                          </h3>
                          <div className="flex flex-col gap-10 p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm">
                             <MetricBar label="èœˆï½¨è´æºç£E‚¯å¤‚ç´«" val={totals.weekly.picConnected} tgt={totals.weekly.calls} />
                             <MetricBar label="èœˆï½¨è´è–™ã„ç¹æ™‰ç´«" val={totals.weekly.appts} tgt={totals.weekly.picConnected} />
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="bg-white border border-slate-100 rounded-[2.5rem] shadow-sm overflow-hidden">
                       <div className="p-6 bg-slate-50 border-b border-slate-100 text-xs font-black flex items-center justify-between text-slate-600 uppercase tracking-widest">
                          <span className="flex items-center gap-3"><Icon p={I.Users} size={16}/> ç¹ï½¡ç¹ï½³ç¹èEãƒ»è›»E¥ç¹ä»£ãƒµç¹§E©ç¹ï½¼ç¹æ§­Î¦ç¹§E¹éš§E³é‚ï½°</span>
                          <span className="text-[10px] text-slate-400">CPHé¬EEâ†“ç¹§E½ç¹ï½¼ç¹ãE/span>
                       </div>
                          ...
                          <table className="w-full text-left border-collapse min-w-[600px]">
                             <thead className="bg-slate-50/50">
                                <tr className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">
                                   <th className="p-6">è±Œä¸éŒ</th>
                                   <th className="p-6">è­«E¶é«®E»è¬¨E°</th>
                                   <th className="p-6">è­›ï½¬è Eºè¬—ï½¥é‚¯ãƒ»/th>
                                   <th className="p-6">é›‰ãEä¾­éš²åŒºE±ãƒ»/th>
                                   <th className="p-6 text-blue-600">ç¹§E¢ç¹ãE/th>
                                   <th className="p-6">1hèœ‰ï½¹é‚EE/th>
                                   <th className="p-6 text-right">éš§E³é‚ï½°</th>
                                </tr>
                             </thead>
             ...
             <div className="bg-white w-full max-w-md p-10 space-y-10 border-4 border-slate-900 rounded-[2.5rem] shadow-2xl overflow-y-auto max-h-[90vh]">
                <div className="flex justify-between items-center border-b-2 border-slate-900 pb-6">
                   <div className="flex items-center gap-4">
                     ...
                     <div>
                       <h3 className="text-2xl font-black text-slate-900">{drilldownMember.name} è±ŒãE/h3>
                       <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{drilldownMember.role} çª¶E¢ 1h/E‚ï½¥{drilldownMember.hourlyWage.toLocaleString()}</p>
                     </div>
                   </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                   {[
                     { label: 'è­«E¶é«®E»è¬¨E°', val: drilldownMember.calls, color: 'text-slate-900' },
                     { label: 'è­›ï½¬è Eºè¬—ï½¥é‚¯ãƒ», val: drilldownMember.picConnected, color: 'text-slate-900' },
                     { label: 'é›‰ãEä¾­éš²åŒºE±ãƒ», val: drilldownMember.requests, color: 'text-slate-900' },
                     { label: 'ç¹§E¢ç¹æ™‰ä½è •ãE, val: drilldownMember.appts, color: 'text-blue-600' },
                     { label: 'è­›æº·E¾ãƒ»æ©è¨E°', val: drilldownMember.expectedAppts, color: 'text-emerald-600' },
                     { label: 'è äº¥E®å¤‚ï½¨E¼èœ’ãE, val: `${drilldownMember.scheduledHours}H`, color: 'text-slate-400' },
                   ].map(stat => (
                ...
                <div className="space-y-4">
                   <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">è­«E¶é«®E»é‚¨å…ˆæ£¡ç¸ºE®èœ€ãƒ»E¨E³éš—ï½£è­«ãƒ»/h4>
                   <div className="space-y-3">
                      {[
                        { label: 'ç¹§E¢ç¹æ™‰ä½è •ãE, val: drilldownMember.appts || 0, color: 'bg-blue-600' },
                        { label: 'é›‰ãEä¾­éš²åŒºE±ãƒ», val: drilldownMember.requests || 0, color: 'bg-emerald-500' },
                        { label: 'è­›ï½¬è Eºè¬—ï½¥é‚¯ãƒ»(ç¸ºæ˜´ãƒ»è‰ãE', val: (drilldownMember.picConnected || 0) - (drilldownMember.appts || 0) - (drilldownMember.requests || 0), color: 'bg-slate-400' },
                        { label: 'èœ¿å¶ºE»ä¿¶æ‹ èœ·E¦', val: drilldownMember.receptionRefusal || 0, color: 'bg-rose-400' },
                        { label: 'è³æ¦Šæƒ  / ç¸ºæ˜´ãƒ»è‰ãE, val: (drilldownMember.calls || 0) - (drilldownMember.picConnected || 0) - (drilldownMember.receptionRefusal || 0), color: 'bg-slate-100' },
                      ].map(item => {
                         ...
                         if (safeVal <= 0 && item.label !== 'ç¹§E¢ç¹æ™‰ä½è •ãE) return null;
                         return (
                            <div key={item.label} className="space-y-1">
                               <div className="flex justify-between text-[9px] font-bold">
                                  <span className="text-slate-500">{item.label}</span>
                                  <span className="text-slate-900">{safeVal}è‰ï½¶ ({p.toFixed(1)}%)</span>
                               </div>
                ...
                <div className="bg-slate-900 p-8 text-white relative rounded-[2rem] overflow-hidden">
                   ...
                   <h4 className="text-[10px] font-bold text-white uppercase mb-4 tracking-widest">è›Ÿå¥æŒ¨è¬Œï½¦é€¡E¥ç¹§E¢ç¹å³¨ãƒ°ç¹§E¤ç¹§E¹</h4>
                ...
                {gasData && (
                   <div className="pt-6 border-t-2 border-slate-100">
                      <h4 className="text-lg font-black text-slate-900 mb-6 flex items-center gap-2"><Icon p={I.Zap} size={20} className="text-blue-600"/> é©•ä¸»æ‚‰ç¸ºE®è¿¯E²è •åŠ±ãƒ§ç¹ï½¼ç¹§E¿</h4>
                ...
                <button onClick={()=>setDrilldownMember(null)} className="w-full bg-slate-900 text-white py-5 font-black rounded-[2rem] shadow-xl hover:bg-black transition-all">é‚¨E±éšªåŒ»E’é«¢å³¨Â§ç¹§ãƒ»/button>
             </div>
          </div>
       )}
       ...
       {editingGoal && (
         <div className="fixed inset-0 z-[200] flex items-center justify-center bg-slate-900/90 p-4">
            <div className="bg-white w-full max-w-sm p-10 space-y-8 border-4 border-slate-900 rounded-3xl shadow-2xl">
               <h3 className="text-xl font-bold">è›Ÿå€¶EºEºé€¶E®è®“å‘µE¨E­è³å£¹ãƒ»è«E®è±E½£</h3>
               <div className="space-y-4">
                  <label className="text-[10px] font-bold text-slate-400 uppercase">é¨¾E±é«¢è–™ã„ç¹æ™‰å²¼è®“å©E»E¶è¬¨E°</label>
               ...
               <button onClick={()=>{
                  ...
                  setEditingGoal(null);
               }} className="w-full bg-slate-900 text-white py-4 font-bold shadow-lg rounded-2xl">éšªE­è³å£¹E’è«æ™ï½­ãƒ»/button>
               <button onClick={()=>setEditingGoal(null)} className="w-full text-slate-400 text-sm font-bold pt-4">ç¹§E­ç¹ï½£ç¹ï½³ç¹§E»ç¹ï½«</button>
            </div>
         </div>
       )}
  ...
  return (
    <div className="space-y-6 pb-24 font-sans">
       <div className="flex flex-col gap-3 border-b-2 border-slate-900 pb-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold flex items-center gap-3">éï½¼èœ’é˜ªãƒ»è Eºè‰ï½¶é›‹ï½»é‚¨E±éšªãƒ»/h2>
          ...
          <div className="flex gap-2 flex-wrap">
            <button onClick={()=>setSelectedMemberId('all')} className={`px-4 py-2 rounded-xl text-xs font-bold border transition-all ${selectedMemberId==='all'?'bg-slate-900 text-white border-slate-900':'bg-white text-slate-500 border-slate-200'}`}>èœˆï½¨èœ©E¡</button>
            {members.map(m => (
       ...
       <div className="grid grid-cols-2 gap-3">
          <div className="bg-slate-900 p-6 text-white rounded-2xl">
             <span className="font-bold opacity-60 text-[10px] block mb-1">éï½¼èœ’è‚´å‡¾é«¢ãƒ»/span>
             <span className="text-3xl font-black">{totalH}<span className="text-sm opacity-30 ml-1">H</span></span>
          </div>
          <div className="bg-white border border-slate-200 p-6 rounded-2xl">
             <span className="font-bold text-slate-400 text-[10px] block mb-1">è Eºè‰ï½¶é›‹ï½»èœ·éƒE½¨ãƒ»/span>
             <span className="text-2xl font-black">E‚ï½¥{totalCost.toLocaleString()}</span>
          </div>
       </div>

       {selectedMemberId === 'all' && memberSummary.length > 0 && (
         <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
           <div className="p-4 bg-slate-50 border-b border-slate-100 text-xs font-black text-slate-500 uppercase tracking-widest">ç¹ï½¡ç¹ï½³ç¹èEãƒ»è›»E¥èœ€ãƒ»E¨E³</div>
           {memberSummary.map(m => (
             <div key={m.id} className="flex items-center justify-between p-4 border-b border-slate-50 last:border-0">
               ...
               <div className="flex items-center gap-4 text-right">
                 ...
                 <span className="font-black text-slate-900 text-sm">E‚ï½¥{m.cost.toLocaleString()}</span>
               </div>
             </div>
           ))}
         </div>
              ...
              <button key={r.id} onClick={()=>onEdit(r)} className="w-full bg-white p-4 flex items-center justify-between text-left hover:bg-slate-50 transition-all">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="font-bold text-slate-800 text-sm">{m?.name || 'è³è‚´ãƒ»'}</span>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <span className="font-bold text-xs text-slate-400">E‚ï½¥{((Number(r.hours)||0) * (Number(m?.hourlyWage)||1500)).toLocaleString()}</span>
                    <span className="text-xl font-black text-slate-900">{r.hours}<span className="text-xs opacity-20 ml-0.5">H</span></span>
                </div>
              </button>
            );
          })}
          {fReports.length === 0 && <div className="py-12 text-center text-slate-400 font-bold text-sm bg-white">ç¸ºè–™ãEè­›æ»E¿£ç¸ºE®ç¹ãEãƒ»ç¹§E¿ç¸ºå¾Œâ‰ ç¹§ç¿«âˆªç¸ºå¸™ï½E/div>}
       </div>
    </div>
  );
};
...
const ShiftView = ({ members, shifts, onAddShift, onDeleteShift, userRole, myMemberId }) => {
  ...
  // é‚‚ï½¡é€EEÂ€ãƒ»ç•‘è³Â€è­ç‰™ãƒ»èœ‰å¸™Î”ç¹ï½¼ç¹ç”»éš¼æ¿¶E¯
  ...
  const handleBulkRegister = async () => {
    if (!bulkMemberId) return alert("ç¹§E¹ç¹§E¿ç¹ãEãƒµç¹§å¸âEè¬šæ§­E ç¸ºE¦ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»);
    if (bulkSchedule.length === 0) return alert("ç¹§E«ç¹ï½¬ç¹ï½³ç¹Â€ç¹ï½¼ç¸ºä¹ï½‰è­Œï½¥è‰å€¥EEç¸ºE¤è‰ï½¥è³ä¼âEè¬šæ§­E ç¸ºE¦ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»);
    
    const mName = members.find(m=>m.id===bulkMemberId)?.name;
    if (window.confirm(`${mName}ç¸ºè¼”ï½“ç¸ºE«éšªãƒ»${bulkSchedule.length} è­Œï½¥é«¢è–™ãEç¹§E·ç¹è¼”ãƒ¨ç¹§å‰E½¸Â€è«¡E¬é€‹ï½»éª­E²ç¸ºåŠ±âˆªç¸ºå¶Â°ãƒ»æ­E) {
      ...
      alert("è³Â€è­èEåŒ³éª­E²ç¸ºæ‚Ÿï½®å¾¡Eºãƒ»E ç¸ºE¾ç¸ºåŠ±â—E¸²ãƒ»);
      setBulkSchedule([]);
      setBulkMode(false);
    }
  };
  ...
  return (
    <div className="space-y-6 pb-24 font-sans">
       <div className="flex flex-col gap-4 border-b-2 border-slate-900 pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <h2 className="text-xl font-bold">ç¹§E·ç¹è¼”ãƒ¨é‚‚ï½¡é€EEãƒ»è Eºèœ©E¡é©Ÿå’²E½E®</h2>
              {userRole === 'admin' && (
                <button 
                ...
                >
                  {bulkMode ? <><Icon p={I.X} size={14}/> ç¹ï½¢ç¹ï½¼ç¹èŠ½E§E£é«¯E¤</> : <><Icon p={I.Zap} size={14}/> è³Â€è­ç‰™ãƒ»èœ‰å¸™Î”ç¹ï½¼ç¹ãE/>}
                </button>
              )}
            </div>
            {!bulkMode && (
              <div className="flex bg-slate-200 p-1 rounded-full">
                 <button onClick={()=>setViewMode('day')} className={`px-3 py-1 text-[10px] font-bold rounded-full transition-all ${viewMode==='day'?'bg-slate-900 text-white':'text-slate-500'}`}>è­Œï½¥è›»E¥</button>
                 <button onClick={()=>setViewMode('week')} className={`px-3 py-1 text-[10px] font-bold rounded-full transition-all ${viewMode==='week'?'bg-slate-900 text-white':'text-slate-500'}`}>é¨¾E±è›»E¥</button>
                 <button onClick={()=>setViewMode('month')} className={`px-3 py-1 text-[10px] font-bold rounded-full transition-all ${viewMode==='month'?'bg-slate-900 text-white':'text-slate-500'}`}>è­›ç£¯ä¿£</button>
              </div>
            )}
          </div>
            ...
            <div className="p-8 bg-rose-50 border-2 border-rose-100 rounded-[2.5rem] space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
               <div className="flex flex-col md:flex-row gap-8 items-start">
                  <div className="flex-1 space-y-4">
                     <label className="text-xs font-black text-rose-500 uppercase tracking-widest block">1. èŸE½¾é›ï½¡ç¹§E¹ç¹§E¿ç¹ãEãƒµç¹§å¸âEè¬šãE/label>
                  ...
                  <div className="space-y-4 bg-white p-6 rounded-3xl border border-rose-100 shadow-sm">
                     <label className="text-[10px] font-black text-rose-500 uppercase tracking-widest block">ç¹ãEãƒµç¹§E©ç¹ï½«ç¹åŸŸå‡¾é«¢æ¥¢E¨E­è³ãƒ»/label>
                     <div className="flex gap-4">
                        <div className="space-y-1">
                           <span className="text-[9px] font-bold text-slate-400">é«¢å¥E§ãƒ»/span>
                        ...
                        <div className="space-y-1">
                           <span className="text-[9px] font-bold text-slate-400">é‚¨ã‚E½ºãƒ»/span>
                     ...
                     <p className="text-[9px] text-slate-400 font-bold mt-2">çª¶E»é©•ï½¸è¬šæ¨Šï½¸åŒ»âˆ©ç¸ºE®è­«E½ç¸ºE«ç¹§ã‚E¸šè­ï¿½ç¸ºè¼”ï½Œç¸ºE¾ç¸ºãƒ»/p>
                  </div>
               </div>

               {bulkSchedule.length > 0 && (
                 <div className="space-y-4 pt-4 border-t border-rose-100">
                    <label className="text-xs font-black text-rose-500 uppercase tracking-widest block">2. èœ·ãƒ»å¾‹éä¹ãEè­ã‚‹ä¿£ç¹§å®šï½ªE¿è¬¨E´</label>
                         ...
                         <div key={item.date} className="flex items-center justify-between p-4 bg-white border border-rose-100 rounded-2xl shadow-sm group">
                            <div className="flex flex-col">
                               ...
                               <span className="text-xs font-bold text-slate-600">
                                 {['è­Œï½¥','è­›ãE,'è½£E«','è±Œï½´','è­›ï½¨','é©¥ãƒ»,'è¨ãƒ»][new Date(item.date).getDay()]}è­–æ‡ˆå¾E
                               </span>
                            </div>
                            <div className="flex items-center gap-2">
               ...
               <div className="flex flex-col md:flex-row items-center justify-between border-t border-rose-100 pt-6 gap-4">
                  <div className="flex items-center gap-3">
                     ...
                     <p className="text-sm font-bold text-rose-600">èœ€ãƒ»E®E¹ç¹§å ¤E¢Eºéš±é˜ªE ç¸ºE¦é€‹ï½»éª­E²ãƒ»è‚²æ¨Ÿè¨E¨ {bulkSchedule.length} è­Œï½¥è›»ãƒ»E¼ãƒ»/p>
                  </div>
                  <button onClick={handleBulkRegister} className="w-full md:w-auto px-10 py-4 bg-rose-600 text-white font-black rounded-[1.5rem] shadow-xl hover:bg-rose-700 transition-all transform active:scale-95 flex items-center justify-center gap-2">
                     <Icon p={I.Check} size={20}/> è³Â€è­èEåŒ³éª­E²ç¹§è²ï½®æº¯E¡ãƒ»
                  </button>
               </div>
            </div>
          )}
          {viewMode === 'month' ? (
            <div className="flex items-center justify-between bg-white border border-slate-200 rounded-2xl px-4 py-3">
              ...
              <span className="font-black text-lg">{calYear}èŸ·E´ {calMonthNum}è­›ãE/span>
         ...
         <div className="space-y-6">
           <div className="p-10 bg-white border border-slate-200 shadow-xl rounded-[2.5rem]">
              <div className="grid grid-cols-7 gap-px bg-slate-100 border border-slate-100 rounded-2xl overflow-hidden">
                 {['è­Œï½¥','è­›ãE,'è½£E«','è±Œï½´','è­›ï½¨','é©¥ãƒ»,'è¨ãƒ»].map((d, i) => (
                   ...
                   return (
                     ...
                     >
                       ...
                       <div className="w-full space-y-1">
                          ...
                          {dayShifts.length > 3 && <div className="text-[8px] font-bold text-slate-300 pl-1">è‰ãE{dayShifts.length - 3} èœ·ãƒ»..</div>}
                       </div>
                     </button>
                   );
                 })}
           ...
           <div className="bg-white border border-slate-200 shadow-xl rounded-[2.5rem] overflow-hidden">
              <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                 <h3 className="text-xl font-black text-slate-900 flex items-center gap-4"><div className="p-3 bg-blue-600 text-white rounded-xl shadow-lg"><Icon p={I.Calendar} size={20}/></div> {selectedDate.split('-')[1]}è­›ãEselectedDate.split('-')[2]}è­Œï½¥ç¸ºE®ç¹§E·ç¹è¼”ãƒ¨éš§E³é‚ï½°</h3>
                 <span className="px-4 py-2 bg-slate-50 rounded-full text-xs font-black text-slate-400 uppercase tracking-widest">{selectedDateShifts.length} èœ·é˜ªãƒ»ç¹§E¹ç¹§E¿ç¹ãEãƒµç¸ºå¾¡Eºäº¥E®ãƒ»/span>
              </div>
              {selectedDateShifts.length === 0 ? (
                 <div className="text-center py-20 text-slate-400 font-bold text-sm">ç¸ºè–™ãEè­Œï½¥ç¸ºE®ç¹§E·ç¹è¼”ãƒ¨é€‹ï½»éª­E²ç¸ºE¯ç¸ºã‚E½Šç¸ºE¾ç¸ºå¸™ï½“ç¸²ã‚E‰¿è³ä¹ãEãƒ»ä¹ãEç¹§E¿ç¹ï½³ç¸ºä¹ï½‰é€‹ï½»éª­E²ç¸ºåŠ±â€»ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»/div>
              ) : (
                        ...
                        <div key={s.id} className="flex items-center justify-between p-8 bg-white hover:bg-slate-50 transition-colors group">
                          ...
                          <div className="flex items-center gap-10">
                             <div className="text-right">
                                <div className="text-[10px] font-bold text-slate-300 uppercase mb-1">èœï½¤èœå‘å‡¾é«¢ãƒ»/div>
                               ...
                               {(userRole === 'admin' || s.memberId === myMemberId) && (
                                  <button onClick={()=>{if(window.confirm('ç¸ºè–™ãEç¹§E·ç¹è¼”ãƒ¨ç¹§è²ç‚é«¯E¤ç¸ºåŠ±âˆªç¸ºå¶Â°ãƒ»ãƒ»)) onDeleteShift(s.id)}} className="p-3 text-slate-200 hover:text-rose-600 hover:bg-rose-50 rounded-2xl transition-all"><Icon p={I.Trash} size={20}/></button>
                               )}
                          </div>
                        </div>
                      );
            ...
            {displayShifts.map(s => {
               ...
               return (
                 <div key={s.id} className="bg-white p-5 flex items-center justify-between hover:bg-slate-50 transition-all border-l-4 border-transparent hover:border-slate-900">
                    ...
                    <button onClick={()=>{if(window.confirm('èœ‘ä¼å‹ç¸ºåŠ±âˆªç¸ºå¶Â°ãƒ»ãƒ»)) onDeleteShift(s.id)}} className="p-2 text-slate-200 hover:text-rose-600 transition-colors"><Icon p={I.Trash} size={18}/></button>
                 </div>
               );
            })}
         </div>
       ...
       {!bulkMode && (
         <button onClick={()=>setShowModal(true)} className="fixed bottom-24 right-6 w-16 h-16 bg-slate-900 text-white flex flex-col items-center justify-center border-4 border-white shadow-2xl z-40 rounded-full hover:scale-105 transition-transform">
           ...
           <span className="text-[7px] font-bold uppercase mt-0.5">é€‹ï½»éª­E²</span>
         </button>
       )}
         ...
         <div className="fixed inset-0 bg-slate-900/95 z-[200] flex items-center justify-center p-4 backdrop-blur-md">
            <div className="bg-white w-full max-w-sm p-10 space-y-8 border-4 border-slate-900 rounded-3xl shadow-2xl">
               <div className="flex justify-between items-center border-b-2 border-slate-100 pb-4">
                  <h3 className="text-xl font-bold">ç¹§E·ç¹è¼”ãƒ¨è­E½°éš•åEåŒ³éª­E²</h3>
                  <button onClick={()=>setShowModal(false)} className="text-slate-400 hover:text-slate-900 transition-colors"><Icon p={I.X} /></button>
               </div>
               <div className="space-y-6">
                  <div>
                    <label className="text-[10px] font-bold text-slate-400 uppercase mb-3 block">è«¡ãƒ»E½è–™ã›ç¹§E¿ç¹ãEãƒµ</label>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <div>
                       <label className="text-[10px] font-bold text-slate-400 uppercase mb-2 block">é«¢å¥E§ãƒ»/label>
                     ...
                     <div>
                       <label className="text-[10px] font-bold text-slate-400 uppercase mb-2 block">é‚¨ã‚E½ºãƒ»/label>
               ...
               <button onClick={()=>setShowModal(false)} className="w-full bg-slate-900 text-white py-4 font-bold rounded-2xl hover:bg-black transition-colors">èœ€ãƒ»E®E¹ç¹§å‰E½¿æ™ï½­ãƒ»/button>
            </div>
         </div>
       )}
    </div>
...
const METRIC_HELP = {
  CPH: 'CPHãƒ»ãƒ»alls Per Hourãƒ»ãƒ» 1è­ã‚‹ä¿£ç¸ºã‚E—†ç¹§ç¿«ãƒ»è­«E¶é«®E»è¬¨E°ç¸²ã‚‰ï½¨E¼èœ’æ¦ŠæŸ‘é‚EEE’é‰Eºç¸ºå‘æ¬ è®“å¶Â€ã‚‹ï½«å€¥Eç¸ºE»ç¸ºE©èœ‰ï½¹é‚EEå™ªç¸²ãƒ»,
  è¬—ï½¥é‚¯å¤‚ç´«: 'è­›ï½¬è Eºè¬—ï½¥é‚¯å¤‚ç´« = è­«E¶é«®E»è¬¨E°ç¸ºE®ç¸ºãƒ»â– è«¡ãƒ»E½æ¥¢Â€ãƒ»æ‚½è Eºç¸ºE¨è¨å¤Šï½©E±ç¸ºE§ç¸ºé˜ªâ—Eœ‘E²èœ·åŒ»Â€ã‚Eœç¹§E¹ç¹åŒ»ãƒ»é›‰ï½ªç¹§å‘ˆï½¸E¬ç¹§åŒºæ¬ è®“å¶Â€ãƒ»,
  ç¹§E¢ç¹æ™‰ç´«: 'ç¹§E¢ç¹æ™‰ç´« = è­›ï½¬è Eºè¬—ï½¥é‚¯å£½ç„šç¸ºE®ç¸ºãƒ»â– ç¹§E¢ç¹æ˜´ãE¹ï½³ç¹åŒ»E’è¿¯E²è •åŠ±ã€’ç¸ºé˜ªâ—Eœ‘E²èœ·åŒ»Â€ã‚Eƒ¨ç¹ï½¼ç¹§E¯ç¸ºE®éœE½¢è¬ å¸›é´¨ç¹§å‘ˆï½¸E¬ç¹§åŒºæ¬ è®“å¶Â€ãƒ»,
  é©•ç–²ãƒ»é‚EE 'é©•ç–²ãƒ»é‚EE= è‰ä¼E€E±ç¸ºE®è›Ÿå€¶EºEºç¹§E¢ç¹æ™‰å²¼è®“å¶â†“èŸ‡E¾ç¸ºå¶E‹è¿´E¾è¨E¨ç¸ºE®è¿¯E²è •ç²ç„šç¸ºE®èœ‘ï½²èœ·åŒ»Â€ãƒ»,
  è­›æº·E¾ãƒ»æ©è¨E°: 'è­›æº·E¾ãƒ»æ©è¨E°è‰ï½¶è¬¨E° = é©•ä¸»æ‚‰ç¸ºE®è³æº½E¸E¾ãƒ»åŒ»ãE¹æ™‰ç´«EE½‘PHãƒ»å˜‰å¶ºE»ä¼E€E±ç¸ºE®è äº¥E®å¤‚ï½¨E¼èœ’è‚´å‡¾é«¢è–™Â°ç¹§è‡¥E®æ€œãEç¸ºåŠ±â—E åŸŸï½¸E¬è›Ÿï½¤ç¸²ãƒ»,
  è­›ï½¬è Eºè¬—ï½¥é‚¯ãƒ» 'è«¡ãƒ»E½æ¥¢Â€ãƒ»æ‚½è Eºç¸ºE¨é€¶E´è¬—ï½¥è¨å¤Šï½©E±ç¸ºE§ç¸ºé˜ªâ—E‰E¶è¬¨E°ç¸²ã‚E¥³è‰ä¿¶E­E¢ç¸ºE¾ç¹§ç¿«EE³æ¦Šæƒ ç¸ºE¯èœ·E«ç¸ºE¾ç¸ºEªç¸ºãƒ»Â€ãƒ»,
};
  ...
  <div className="fixed inset-0 z-[500] flex items-end md:items-center justify-center bg-slate-900/80 backdrop-blur-sm p-4" onClick={onClose}>
    <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden" onClick={e=>e.stopPropagation()}>
      <div className="p-6 bg-slate-900 text-white flex items-center justify-between">
        <h3 className="font-black text-lg flex items-center gap-3"><Icon p={I.Help} size={20} color="white"/>è¬–ãEE¨å¶ãç¹§E¤ç¹ãE/h3>
...
const AnalyticsView = ({ members, reports, event, userRole }) => {
  ...
  const trendData = useMemo(() => {
    ...
    fReports.forEach(r => {
      ...
      if (periodMode === 'daily') key = toLocalDateString(dateObj).slice(-5);
        ...
        key = `${dateObj.getMonth()+1}è­›ãE;
      } else {
        key = `${dateObj.getFullYear()}èŸ·E´`;
      }
  ...
  const metricLabels = { 
    calls:'è­«E¶é«®E»è¬¨E°', 
    appts:'ç¹§E¢ç¹æ™‰ä½è •ç²ç„E, 
    requests:'é›‰ãEä¾­éš²åŒºE±ã‚ˆçE', 
    picConnected:'è­›ï½¬è Eºè¬—ï½¥é‚¯å£½ç„E,
    receptionRefusal:'èœ¿å¶ºE»ä¿¶æ‹ èœ·E¦',
    picAbsent:'è«¡ãƒ»E½è¬ï½¸æ¦Šæƒ ',
    noAnswer:'è³æ¦Šæƒ /ç¸ºæ˜´ãƒ»è‰ãE
  };
  const periodLabels = { daily:'è­Œï½¥è°ºE¡', weekly:'é¨¾E±è°ºE¡', monthly:'è­›åŸŸE¬E¡', yearly:'èŸ·E´è°ºE¡' };
  ...
  return (
    <div className="space-y-10 pb-28">
       ...
       <div className="flex flex-col md:flex-row md:items-center justify-between border-b-2 border-slate-900 pb-4 gap-4">
          <div className="flex items-center gap-3">
            <h2 className="text-xl font-black flex items-center gap-3"><Icon p={I.PieChart} size={20}/> ç¹åŠ±ÎŸç¹§E¸ç¹§E§ç¹§E¯ç¹äº¥E¤å¤Šï½§è²ãEè­«ãƒ»/h2>
            <button onClick={()=>setShowHelp(true)} className="p-2 rounded-full bg-slate-100 hover:bg-blue-100 text-slate-400 hover:text-blue-600 transition-colors" title="è¬–ãEE¨å¶ãƒ»éš±E¬è­ãE>
          ...
          <select className="bg-white border border-slate-300 p-2 px-4 font-bold text-xs outline-none rounded-xl shadow-sm" value={selectedMid} onChange={e=>setSelectedMid(e.target.value)}>
             <option value="all">ç¹âEãƒ»ç¹ï¿½èœˆï½¨è´è–™ãEè¬—ï½¨é˜ï½»ç¹§å®šï½¡E¨é‰ï½º</option>
       ...
       <div className="bg-white p-6 md:p-10 rounded-[3rem] border border-slate-100 shadow-xl space-y-6">
          <div className="flex flex-col gap-4">
             <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
               <div className="space-y-1">
                  <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest">ç¹åŒ»Îç¹ï½³ç¹å³¨ãƒ»ç¹ï½¢ç¹ä¹ã¡ç¹ï½ªç¹ï½³ç¹§E°</h3>
                  <div className="text-2xl font-black text-slate-900">{metricLabels[chartMetric]}ç¸ºE®è¬—ï½¨é˜ï½»</div>
               </div>
             ...
             <div className="flex flex-wrap gap-2">
               ...
               <div className="flex bg-slate-100 p-1 rounded-xl gap-1">
                 <button onClick={()=>setChartType('line')} className={`px-3 py-1.5 text-[10px] font-black rounded-lg transition-all ${chartType==='line'?'bg-blue-600 text-white':'text-slate-400'}`}>è¬šå€¥EŒé‚±ãƒ»/button>
                 <button onClick={()=>setChartType('area')} className={`px-3 py-1.5 text-[10px] font-black rounded-lg transition-all ${chartType==='area'?'bg-blue-600 text-white':'text-slate-400'}`}>ç¹§E¨ç¹ï½ªç¹§E¢</button>
               </div>
             </div>
          </div>
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-10">
             <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">éœE½¢è¬ å¸™ãEèœ‰ï½¹é‚EEE¼ãƒ»VRãƒ»ãƒ»/h3>
             <div className="space-y-10">
                <MetricBar label="è¬—ï½¥é‚¯å¤‚ç´« (è­«E¶é«®E»è±ˆãE" val={stats.picConnected} tgt={stats.calls} />
                <MetricBar label="ç¹§E¢ç¹æ™‰ç´« (è¬—ï½¥é‚¯å£½E¯ãƒ»" val={stats.appts} tgt={stats.picConnected} />
             </div>
          </div>
          ...
          <section className="p-10 bg-slate-900 text-white relative rounded-[2.5rem] shadow-xl overflow-hidden min-h-[300px] flex flex-col justify-between border border-slate-800">
             ...
             <div className="relative z-10 space-y-8">
                <div className="flex items-center gap-3">
                   ...
                   <h3 className="text-xs font-black text-white uppercase tracking-widest">AIè¬Œï½¦é€¡E¥ç¹§E¢ç¹å³¨ãƒ°ç¹§E¤ç¹§E¶ç¹ï½¼</h3>
                </div>
             ...
             <div className="relative z-10 border-t border-white/10 pt-6 flex items-center justify-between text-[11px] font-black text-slate-500 uppercase tracking-widest">
                <span className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-emerald-500 rounded-full"></div> ç¹ï½ªç¹§E¢ç¹ï½«ç¹§E¿ç¹§E¤ç¹ï¿½éš—ï½£è­«è‰ï½¸E­</span>
                <span className="opacity-40 italic text-white/50">è±ºE±è»E¤è›»ãƒ»æ¢µç¹§E¨ç¹ï½³ç¹§E¸ç¹ï½³ v5.0.3</span>
             </div>
          </section>
       </div>
    </div>
...
const Settings = ({ events, currentEventId, members, onAddEvent, onDeleteEvent, onAddMember, onDelMember, onUpdateMember, onUpdateGoal, currentBaseDate, onClose }) => {
  ...
  const handleSaveSyncSettings = () => {
    ...
    alert("èœ·æ¢§æ‚EšªE­è³å£¹E’è«æ™ï½­å€¥E ç¸ºE¾ç¸ºåŠ±â—E¸²ãƒ»);
  };

  const handleManualSync = async () => {
    if (!gasUrl) return alert("GASç¸ºE®URLç¹§å®šï½¨E­è³å£¹E ç¸ºE¦ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼ç¸²ãƒ»);
    setIsSyncing(true);
    try {
      ...
      alert("èœ·æ¢§æ‚E¹ï½ªç¹§E¯ç¹§E¨ç¹§E¹ç¹åŒ»E’é¨¾âˆ½E¿E¡ç¸ºåŠ±âˆªç¸ºåŠ±â—E¸²ãƒ»oogleç¹§E¹ç¹åŠ±Îç¹ãEãƒ©ç¹§E·ç¹ï½¼ç¹äº¥ãƒ»ç¸ºE®GASç¸ºæ¢§E­E£ç¸ºåŠ±E¥éšªE­è³å£¹EE¹§å¾Œâ€»ç¸ºãƒ»EŒç¸ºE°ç¸²âˆµç„šè›»ãƒ»E»E¥èœ€ãƒ»â†“ç¹ãEãƒ»ç¹§E¿ç¸ºæ‚Ÿæ¸šè­ï¿½ç¸ºè¼”ï½Œç¸ºE¾ç¸ºå¶Â€ãƒ»);
    } catch (e) {
      alert("èœ·æ¢§æ‚E¹ï½ªç¹§E¯ç¹§E¨ç¹§E¹ç¹åŒ»ãƒ»é¨¾âˆ½E¿E¡ç¸ºE«èŸï½±è¬¨åŠ±E ç¸ºE¾ç¸ºåŠ±â—E " + e.message);
    }
    setIsSyncing(false);
  };
    ...
    <div className="space-y-12 pb-40 font-sans">
       <div className="flex items-center justify-between border-b-4 border-slate-900 pb-6">
          <div className="flex items-center gap-6">
             ...
             <div><h2 className="font-black text-3xl text-slate-900 leading-none">ç¹§E·ç¹§E¹ç¹ãEÎ’é¬®ä¼œï½ºE¦é‚‚ï½¡é€EE/h2><p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter mt-1">é‚‚ï½¡é€EEÂ€ãƒ»E¨E©é«¯èˆŒãEç¸ºE¿ç¸²ã‚E½¸Â€é—Šï½¬ç¹§E¹ç¹§E¿ç¹ãEãƒµç¸ºE¯é«¢E²éš•ï½§ç¸ºE§ç¸ºé˜ªâˆªç¸ºå¸™ï½“ç¸²ãƒ»/p></div>
          </div>
       </div>

       <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <section className="space-y-6">
             <h3 className="text-sm font-bold text-slate-800 border-l-4 border-slate-900 pl-3">è­¯äº•ï½»E¶ç¹ï½»ç¹åŠ±ÎŸç¹§E¸ç¹§E§ç¹§E¯ç¹ãE/h3>
             <div className="p-8 bg-white border border-slate-200 space-y-4 shadow-sm rounded-3xl">
                <input className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold focus:border-slate-900 outline-none rounded-xl" placeholder="è­E½°éš•ä¹—ï½¡äº•ï½»E¶èœ·ãƒ» value={newEName} onChange={e=>setNewEName(e.target.value)} />
                <button onClick={()=>{if(newEName){onAddEvent(newEName, ""); setNewEName("");}}} className="w-full bg-slate-900 text-white py-4 font-bold rounded-2xl hover:bg-black transition-colors">è­¯äº•ï½»E¶ç¹§åµãƒ§ç¹ï½¼ç¹§E¿ç¹å¶ãƒ»ç¹§E¹ç¸ºE«é€‹ï½»éª­E²</button>
             </div>
             <div className="flex flex-col gap-px bg-slate-200 border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
                {events.map(e => (
                  <div key={e.id} className="flex items-center justify-between p-4 bg-white text-sm font-bold">
                     <span>{e.name}</span>
                     <button onClick={()=>{if(window.confirm('ç¸ºè–™ãEè­¯äº•ï½»E¶ç¹§è²ï½®æ‚ŸãEç¸ºE«èœ‘ä¼å‹ç¸ºåŠ±âˆªç¸ºå¶Â°ãƒ»ãƒ»)) onDeleteEvent(e.id)}} className="text-slate-300 hover:text-rose-600 transition-colors"><Icon p={I.Trash} size={18}/></button>
                  </div>
                ))}
             </div>

             <h3 className="text-sm font-bold text-slate-800 border-l-4 border-indigo-600 pl-3 mt-12">èœˆï½¨è´é‹å²¼è®“å¶ãƒ»éšªE­è³ãƒ»(é‚‚ï½¡é€EEÂ€ãƒ»ãƒ»ç¸ºE¿)</h3>
             <div className="p-8 bg-white border border-slate-200 space-y-6 shadow-sm rounded-3xl">
                <div className="space-y-4">
                   <label className="text-[10px] font-bold text-slate-400 uppercase">è‰ä¼E€E±ç¸ºE®èœˆï½¨è´è–™ã„ç¹æ˜´ãE¹ï½³ç¹è‚²å²¼è®“ãE/label>
                   <div className="flex gap-4">
                      ...
                      <button onClick={() => {
                         ...
                         alert("èœˆï½¨è´é‹å²¼è®“å¶E’è­–ï½´è­E½°ç¸ºåŠ±âˆªç¸ºåŠ±â—E¸²ãƒ»);
                      }} className="px-8 bg-indigo-600 text-white font-bold rounded-2xl">è«æ™ï½­ãƒ»/button>
                   </div>
                </div>
             </div>

             <h3 className="text-sm font-bold text-slate-800 border-l-4 border-blue-600 pl-3 mt-12">èŸå¤œÎšç¹ãEãƒ»ç¹§E¿èœ·æ¢§æ‚E(GAS / é©•ä¸»æ‚‰ç¹ãEãƒ»ç¹§E¿)</h3>
             <div className="p-8 bg-white border border-slate-200 space-y-6 shadow-sm rounded-3xl">
                ...
                <div className="space-y-2">
                   <label className="text-[10px] font-bold text-slate-400 uppercase">é©•ä¸»æ‚‰ç¹ãEãƒ»ç¹§E¿è ‘æEE¶å¶â„E€•ï½¨ App ID</label>
                   <input className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold outline-none rounded-xl text-xs" placeholder="è“ãE tele-apo-manager-original" value={legacyAppId} onChange={e=>setLegacyAppId(e.target.value)} />
                </div>
                <div className="grid grid-cols-2 gap-4">
                   <button onClick={handleSaveSyncSettings} className="w-full bg-white border-2 border-slate-200 text-slate-600 py-4 font-bold rounded-2xl hover:bg-slate-50 transition-colors">éšªE­è³å£¹E’è«æ™ï½­ãƒ»/button>
                   <button onClick={handleManualSync} disabled={isSyncing} className="w-full bg-blue-600 text-white py-4 font-bold rounded-2xl hover:bg-blue-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2">
                      <Icon p={I.Zap} size={18} /> {isSyncing ? 'èœ·æ¢§æ‚E³E­...' : 'è‰ç¿«â˜E¸ºä»™éEè­›ãE}
                   </button>
                </div>
             </div>
          </section>
          ...
          <section className="space-y-6">
             <h3 className="text-sm font-bold text-slate-800 border-l-4 border-emerald-600 pl-3">ç¹âEãƒ»ç¹ï¿½ç¹ï½»é‚¨E¦è³å–ï½§åŒºãƒ»</h3>
             <div className="p-8 bg-white border border-slate-200 space-y-4 shadow-sm rounded-3xl">
                <div className="grid grid-cols-2 gap-4">
                   <input className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold rounded-xl" placeholder="è±Œä¸éŒ" value={newMName} onChange={e=>setNewMName(e.target.value)} />
                   <input className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold rounded-xl" placeholder="ç¹§E¹ç¹åŠ±ã™é™¦E¨é‰ï½ºèœ·ãƒ»èœ·æ¦Šï½­ãƒ»" value={newSpreadsheetName} onChange={e=>setNewSpreadsheetName(e.target.value)} />
                </div>
                <div className="grid grid-cols-2 gap-4">
                   ...
                   <select className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold outline-none rounded-xl" value={newRole} onChange={e=>setNewRole(e.target.value)}>
                      <option value="apo">ç¹§E¢ç¹æ˜´ãE¹ï½³ç¹§E¿ç¹ï½¼</option>
                      <option value="closer">ç¹§E¯ç¹ï½­ç¹ï½¼ç¹§E¶ç¹ï½¼</option>
                      <option value="admin">é‚‚ï½¡é€EEÂ€ãƒ»/option>
                   </select>
                </div>
                <div className="grid grid-cols-1 gap-4">
                   <input type="number" className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold outline-none rounded-xl" placeholder="è­ã‚‰EµE¦" value={newWage} onChange={e=>setNewWage(e.target.value)} />
                </div>
                <button onClick={()=>{if(newMName){onAddMember(newMName, newRole, newWage, newEmail, newSpreadsheetName); setNewMName(""); setNewEmail(""); setNewSpreadsheetName("");}}} className="w-full bg-emerald-600 text-white py-4 font-bold rounded-2xl hover:bg-emerald-700 transition-colors">ç¹§E¹ç¹§E¿ç¹ãEãƒµç¹§å‘ˆçœ éš•åEåŒ³éª­E²</button>
             </div>
             <div className="flex flex-col gap-px bg-slate-200 border border-slate-200 rounded-3xl overflow-hidden shadow-sm">
                {members.map(m => (
                  <button key={m.id} onClick={() => setEditingMember(m)} className="p-4 bg-white flex items-center justify-between text-left hover:bg-slate-50 group transition-colors">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           <div className="font-bold text-slate-900">{m.name}</div>
                           <div className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">E‚ï½¥{m.hourlyWage}/H çª¶E¢ {m.role}</div>
                        </div>
                     </div>
       ...
       {editingMember && (
         <div className="fixed inset-0 bg-slate-900/95 z-[300] flex items-center justify-center p-6 backdrop-blur-md">
            <div className="bg-white w-full max-w-sm p-10 space-y-8 border-4 border-slate-900 rounded-3xl shadow-2xl">
               <h3 className="text-xl font-bold border-b-2 border-slate-100 pb-4">ç¹§E¹ç¹§E¿ç¹ãEãƒµè« ãƒ»E½E±ç¸ºE®è«E®è±E½£</h3>
               <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                     <input className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold rounded-xl" value={editingMember.name} onChange={e=>setEditingMember({...editingMember, name: e.target.value})} placeholder="è±Œä¸éŒ" />
                     <input className="w-full p-4 bg-slate-50 border-2 border-slate-100 font-bold rounded-xl" value={editingMember.spreadsheetName || ''} onChange={e=>setEditingMember({...editingMember, spreadsheetName: e.target.value})} placeholder="ç¹§E¹ç¹åŠ±ã™é™¦E¨é‰ï½ºèœ·ãƒ» />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                     ...
                     <input type="number" className="w-full p-4 bg-slate-50 border-2 border-slate-200 font-bold outline-none rounded-xl" value={editingMember.hourlyWage} onChange={e=>setEditingMember({...editingMember, hourlyWage: e.target.value})} placeholder="è­ã‚‰EµE¦" />
                  </div>
               </div>
               <div className="grid grid-cols-2 gap-4">
                  <button onClick={()=>{onDelMember(editingMember.id); setEditingMember(null);}} className="bg-rose-50 text-rose-500 py-4 font-bold border border-rose-100 transition-all active:bg-rose-100 rounded-2xl">èœ‘ä¼å‹</button>
                  <button onClick={()=>{onUpdateMember(editingMember.id, editingMember); setEditingMember(null);}} className="bg-slate-900 text-white py-4 font-bold transition-all active:bg-black rounded-2xl">è­–ï½´è­E½°ç¹§å ¤E¢Eºè³ãƒ»/button>
               </div>
               <button onClick={()=>setEditingMember(null)} className="w-full text-slate-400 text-sm font-bold pt-4 hover:text-slate-900 transition-colors">ç¹§E­ç¹ï½£ç¹ï½³ç¹§E»ç¹ï½«</button>
            </div>
         </div>
       )}
    </div>
...
function InputModal({ members, onAdd, onUpdate, onDelete, onClose, initialData = null }) {
  ...
  const submit = (e) => { e.preventDefault(); if (!val.memberId) return alert("ç¹§E¹ç¹§E¿ç¹ãEãƒµç¹§å¸âEè¬šæ§­E ç¸ºE¦ç¸ºä¸Šâ–¡ç¸ºè¼”ï¼E); const d = { ...val, calls: Number(val.calls), appts: Number(val.appts), requests: Number(val.requests), lost: Number(val.lost), deals: Number(val.deals), hours: Number(val.hours), picConnected: Number(val.picConnected), noAnswer: Number(val.noAnswer), receptionRefusal: Number(val.receptionRefusal), picAbsent: Number(val.picAbsent), outOfTarget: Number(val.outOfTarget) }; if (initialData) onUpdate(d); else onAdd(d); onClose(); };
    ...
    <div className="fixed inset-0 bg-slate-900/60 z-[100] flex flex-col md:items-center md:justify-center p-4">
       <div className="w-full h-full md:max-w-2xl md:h-auto bg-white border-2 border-slate-900 flex flex-col overflow-hidden shadow-2xl rounded-3xl">
          <div className="p-6 border-b-2 border-slate-100 flex justify-between items-center bg-slate-50">
             ...
             <h2 className="font-bold text-xl uppercase tracking-widest">è³æº½E¸E¾è£E±èœ»é›ãEèœ‰ãE/h2>
             <div className="w-10"/>
          </div>
          <form onSubmit={submit} className="flex-1 overflow-y-auto p-8 space-y-10">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-slate-200 border border-slate-200 shadow-sm rounded-3xl overflow-hidden">
                <div className="bg-white"><InputItem label="èœˆï½¨è´æºæ¥”é«®E»è¬¨E°" icon={I.Phone} val={val.calls} set={v=>setVal({...val, calls: v})} /></div>
                <div className="bg-white"><InputItem label="è­›ï½¬è Eºè¬—ï½¥é‚¯å£½ç„E icon={I.Zap} val={val.picConnected} set={v=>setVal({...val, picConnected: v})} /></div>
                <div className="bg-white"><InputItem label="ç¹§E¢ç¹æ˜´ãE¹ï½³ç¹ãE icon={I.Check} val={val.appts} set={v=>setVal({...val, appts: v})} /></div>
                <div className="bg-white"><InputItem label="é›‰ãEä¾­éš²åŒºE±ãƒ» icon={I.FileText} val={val.requests} set={v=>setVal({...val, requests: v})} /></div>
                
                <div className="bg-white"><InputItem label="èœ¿å¶ºE»ä¿¶æ‹ èœ·E¦" icon={I.Ban} val={val.receptionRefusal} set={v=>setVal({...val, receptionRefusal: v})} /></div>
                <div className="bg-white"><InputItem label="è«¡ãƒ»E½è¬ï½¸æ¦Šæƒ " icon={I.Users} val={val.picAbsent} set={v=>setVal({...val, picAbsent: v})} /></div>
                <div className="bg-white"><InputItem label="è³æ¦Šæƒ /ç¸ºæ˜´ãƒ»è‰ãE icon={I.Phone} val={val.noAnswer} set={v=>setVal({...val, noAnswer: v})} /></div>
                <div className="bg-white"><InputItem label="éï½¼èœ’è‚´å‡¾é«¢ãƒ» icon={I.Clock} val={val.hours} set={v=>setVal({...val, hours: v})} /></div>
             </div>
             <button className="w-full bg-slate-900 text-white py-6 font-bold text-lg hover:bg-black transition-all rounded-2xl">è³æº½E¸E¾ç¹§å ¤E¢Eºè³å£¹E é¨¾âˆ½E¿E¡</button>
          </form>
       </div>
    </div>
  );
...
// ==========================================
// 5. GASé¨¾E£è¬³Eºç¹ãEãƒ»ç¹§E¿é™¦E¨é‰ï½ºç¹§E³ç¹ï½³ç¹æ˜´ãƒ»ç¹é˜ªÎ¦ç¹ãE
// ==========================================
const GasSyncDataView = ({ gasData, members, forcedMemberId = null, hideHeader = false, onEditGasRecord, onDeleteGasRecord }) => {
  ...
  const STATUS_LIST = [
    { key: 'è­E½°éš•ãE, label: 'è­E½°éš•ãE, color: 'text-slate-600' },
    { key: 'è«¡ãƒ»E½æ¥¢Â€ãƒ»E¸æ¦Šæƒ ', label: 'è«¡ãƒ»E½æ¥¢Â€ãƒ»E¸æ¦Šæƒ ', color: 'text-slate-600' },
    { key: 'è¬šå€¥EŠéœ‘æ–ï¼ ', label: 'è¬šå€¥EŠéœ‘æ–ï¼ ', color: 'text-orange-500' },
    { key: 'èœ€è‚´æ¥”é«®E»E½æ«¨', label: 'èœ€è‚´æ¥”é«®E»E½æ«¨', color: 'text-rose-500' },
    { key: 'èœ€è‚´æ¥”é«®E»E½ãƒ»', label: 'èœ€è‚´æ¥”é«®E»E½ãƒ»', color: 'text-pink-500' },
    { key: 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å“E, label: 'é›‰ãEä¾­A', color: 'text-emerald-600' },
    { key: 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å’¤', label: 'é›‰ãEä¾­B', color: 'text-emerald-500' },
    { key: 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å’¾', label: 'é›‰ãEä¾­C', color: 'text-emerald-400' },
    { key: 'ç¹§E¢ç¹æ™‰E¢Eºè³ãƒ», label: 'ç¹§E¢ç¹æ™‰E¢Eºè³ãƒ», color: 'text-blue-600' },
    { key: 'èœ¿å¶ºE»ä¿¶æ‹ èœ·E¦', label: 'èœ¿å¶ºE»ä¿¶æ‹ èœ·E¦', color: 'text-rose-600' },
    { key: 'è«¡ãƒ»E½æ¥¢Â€ãƒ»æ‹ èœ·E¦', label: 'è«¡ãƒ»E½æ¥¢Â€ãƒ»æ‹ èœ·E¦', color: 'text-rose-700' },
    { key: 'èŸï½¶è®Œï½­è­ã‚‹ä¿£èŸãE, label: 'èŸï½¶è®Œï½­è­ã‚‹ä¿£èŸãE, color: 'text-slate-500' },
    { key: 'call', label: 'è­«E¶é«®E» (é–¾EªèœãE', color: 'text-slate-400' },
    { key: 'appt', label: 'ç¹§E¢ç¹ãE(é–¾EªèœãE', color: 'text-blue-400' },
    { key: 'request', label: 'é›‰ãEä¾­ (é–¾EªèœãE', color: 'text-emerald-400' },
    { key: 'meeting', label: 'è ãƒ»E«ãƒ»(é–¾EªèœãE', color: 'text-purple-400' }
  ];
  ...
  return (
    <div className="space-y-8 pb-24 font-sans">
       <div className={`flex flex-col md:flex-row items-start md:items-center justify-between border-b-2 border-slate-900 pb-4 gap-4 ${hideHeader ? 'border-none pb-0' : ''}`}>
          {!hideHeader && <h2 className="text-xl font-bold flex items-center gap-3"><Icon p={I.Zap} size={24} className="text-blue-600"/> GASé–¾Eªèœå‹Ÿé…”è­›æº˜ãƒ§ç¹ï½¼ç¹§E¿</h2>}
          <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto ml-auto">
            ...
            >
              <option value="all">èœˆï½¨è­›æ»E¿£ (All Time)</option>
              <option value="today">è‰é ‘å¾E(Today)</option>
              <option value="week">é€¶E´éœ‘ãEé¨¾E±é«¢ãƒ»(7 Days)</option>
              <option value="month">è‰é ‘æ€¦ (This Month)</option>
            </select>
            {!forcedMemberId && (
              <select 
              ...
              >
                <option value="all">èœˆï½¨èœ©E¡ç¸ºE®ç¹ãEãƒ»ç¹§E¿ (All)</option>
                {uniqueMembersForDropdown.map(m => (
                  <option key={m.id} value={m.id}>{m.name} ç¸ºE®ç¹ãEãƒ»ç¹§E¿</option>
                ))}
              </select>
            )}
          </div>
       ...
       {dailyTrend.length > 0 && (
         <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm h-[300px]">
           <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">ç¹§E¢ç¹§E¯ç¹§E·ç¹ï½§ç¹ï½³è¬¨E°ç¸ºE®è¬—ï½¨é˜ï½»</h3>
       ...
       <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
         <div className="bg-slate-900 text-white p-6 rounded-3xl shadow-sm flex flex-col items-center col-span-2 md:col-span-4">
             <div className="text-xs font-bold text-slate-400 uppercase">é©•ï½¸è¬šæ¨”ï½¸E­ç¸ºE®ç¹§E¢ç¹§E¯ç¹§E·ç¹ï½§ç¹ï½³é‚±ä¹—çE</div>
       ...
       <div className="space-y-2">
          <h3 className="text-sm font-bold text-slate-500 pl-2">è­›Â€éœ‘ä»£ãƒ»è»E¥è±E½´</h3>
             ...
             return (
               <div key={i} className="flex items-center justify-between p-4 bg-white border border-slate-100 rounded-2xl hover:shadow-md transition-all">
                  <div className="flex flex-col">
                     ...
                     <span className="text-[10px] text-slate-400 font-bold">{d.industry || 'è­›ï½ªéšªE­è³ãƒ»}</span>
                  </div>
                  <div className="flex items-center gap-4">
                     ...
                     {(onEditGasRecord && onDeleteGasRecord) && (
                       <div className="flex gap-1 ml-2">
                          ...
                          <button onClick={()=>{ if(window.confirm('è­›ï½¬è –è–™â†“ç¸ºè–™ãEéšªå€¬é¹¸ç¹§è²ç‚é«¯E¤ç¸ºåŠ±âˆªç¸ºå¶Â°ãƒ»ãƒ»)){ onDeleteGasRecord(d.id); } }} className="p-2 text-slate-400 hover:text-rose-600 rounded-lg transition-colors"><Icon p={I.Trash} size={14}/></button>
                       </div>
                     )}
                  </div>
               </div>
          ...
          {filteredData.length === 0 && (
            <div className="p-8 text-center text-slate-400 font-bold bg-white rounded-3xl border border-slate-100">
              ç¸ºE¾ç¸ºE½èœ·æ¢§æ‚E¸ºè¼”ï½Œç¸ºæº˜ãƒ§ç¹ï½¼ç¹§E¿ç¸ºå¾Œâ‰ ç¹§ç¿«âˆªç¸ºå¸™ï½E
            </div>
          )}
       </div>
       ...
       {editingData && (
         <div className="fixed inset-0 z-[300] flex items-center justify-center bg-slate-900/90 p-4">
           <div className="bg-white w-full max-w-sm p-10 space-y-8 border-4 border-slate-900 rounded-3xl shadow-2xl">
             <h3 className="text-xl font-bold">éšªå€¬é¹¸ç¸ºE®è«E®è±E½£ ({editingData.memberId})</h3>
             <div className="space-y-4">
                <label className="text-sm font-bold text-slate-600">ç¹§E¹ç¹ãEãƒ»ç¹§E¿ç¹§E¹èŸç”»å³©</label>
                <select 
             ...
             <div className="grid grid-cols-2 gap-4">
                <button onClick={()=>setEditingData(null)} className="w-full text-slate-500 bg-slate-100 py-4 font-bold rounded-2xl">ç¹§E­ç¹ï½£ç¹ï½³ç¹§E»ç¹ï½«</button>
                <button onClick={()=>{onEditGasRecord(editingData.id, {type: editingData.type}); setEditingData(null);}} className="w-full bg-slate-900 text-white py-4 font-bold shadow-lg rounded-2xl">è«æ™ï½­ãƒ»/button>
             </div>
           </div>
         </div>
       )}
...
// ==========================================
// 6. ç¹ï½¡ç¹§E¤ç¹ï½³Appç¹§E³ç¹ï½³ç¹æ˜´ãƒ»ç¹é˜ªÎ¦ç¹ãE(Logic)
// ==========================================
...
function App() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.error(e);
      alert("ç¹ï½­ç¹§E°ç¹§E¤ç¹ï½³ç¸ºE«èŸï½±è¬¨åŠ±E ç¸ºE¾ç¸ºåŠ±â—E¸²ã‚Šï½©E³é‚ï½°ãƒ»ãƒ»" + e.message);
    }
  };
    ...
    const unsubAuth = onAuthStateChanged(auth, async (u) => {
      ...
      if (u) {
        ...
        onSnapshot(eCol, (s) => {
          ...
          if (list.length === 0) {
            const newEvent = { name: "ç¹§E¤ç¹å¶Î¦ç¹ãE2026", date: "2026-06-30", goals: defaultGoals, weeklyGoals: {}, createdAt: Timestamp.now() };
  ...
  const totals = useMemo(() => {
    ...
    const sumGas = (arr) => arr.reduce((acc, d) => {
      acc.calls += 1;
      if (d.type === 'ç¹§E¢ç¹æ™‰E¢Eºè³ãƒ») acc.appts += 1;
      if (d.type === 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å“E || d.type === 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å’¤' || d.type === 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å’¾') acc.requests += 1;
      return acc;
    ...
    // è‰ä¼E€E±ç¸ºE®èœˆï½¨ç¹ï½¡ç¹ï½³ç¹èEãƒ»ç¸ºE®ç¹§E·ç¹è¼”ãƒ¨ç¸ºä¹ï½‰é‚±ä¸ˆï½ºäº¥E®å£½å‡¾é«¢è–™ï½’é‚‚æ€œãE
  ...
  const memberStats = useMemo(() => {
    ...
    // è³Â€è •ç‹—å²¼è®“å¶ãƒ»é‚‚æ€œãEãƒ»åŒ»Î“ç¹ï½³ç¹èEãƒ»è¬¨E°ç¸ºE§èœ‘ï½²ç¹§å…·E¼ãƒ»
    ...
    return members.map(m => {
      ...
      gasData.filter(d => d.memberId === m.spreadsheetName || d.memberId === m.name).forEach(d => {
        myTot.calls += 1;
        if (d.type === 'ç¹§E¢ç¹æ™‰E¢Eºè³ãƒ») myTot.appts += 1;
        if (d.type === 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å“E || d.type === 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å’¤' || d.type === 'é›‰ãEä¾­é¨¾âˆ½E»å€E½ºäº¥E®å’¾') myTot.requests += 1;
        if (d.type === 'è«¡ãƒ»E½æ¥¢Â€ãƒ»E¸æ¦Šæƒ ' || d.type === 'è¬šå€¥EŠéœ‘æ–ï¼ ' || d.type === 'èœ€è‚´æ¥”é«®E»E½æ«¨' || d.type === 'èœ€è‚´æ¥”é«®E»E½ãƒ»' || d.type === 'èŸï½¶è®Œï½­è­ã‚‹ä¿£èŸãE) myTot.picAbsent += 1;
        if (d.type === 'èœ¿å¶ºE»ä¿¶æ‹ èœ·E¦') myTot.receptionRefusal += 1;
        if (d.type === 'è«¡ãƒ»E½æ¥¢Â€ãƒ»æ‹ èœ·E¦') myTot.outOfTarget += 1;
      });
      ...
      // è‰ä¼E€E±ç¸ºE®éï½¼èœ’å ºEºäº¥E®å£½å‡¾é«¢è–™ãEéšªè‚²E®ãƒ»
      ...
      // è­›æº·E¾ãƒ»ãE¹æ™„ç„šç¸ºE®éšªè‚²E®ãƒ» (é©•ä¸»æ‚‰ç¸ºE®ç¹§E¢ç¹æ™„ç„E/ é©•ä¸»æ‚‰ç¸ºE®éï½¼èœ’è‚´å‡¾é«¢ãƒ» * è‰ä¼E€E±ç¸ºE®è äº¥E®å£½å‡¾é«¢ãƒ»
      // ç¹ãEãƒ»ç¹§E¿è³å´ï½¶E³ç¸ºE®è£E´èœ·åŒ»ãƒ»èœˆï½¨è´ç˜ï½¹E³è®ãƒ»E¼åŒ»â‰ ç¹§ä¹ï¼ç¸ºE¯0.05éå¥EºE¦ãƒ»å³¨E’è‰E®é„‚ï½®ç¸ºãƒ»
         ...
         <div className="w-full max-sm bg-white border border-slate-100 p-12 shadow-2xl space-y-12 text-center rounded-[3rem]">
            <div className="space-y-6">
               ...
               <div className="space-y-2">
                ...
                <p className="text-slate-400 text-sm font-bold">é¬®å€¡E²E¾è ï½¦ç¸ºEªè³æº½E¸E¾é‚‚ï½¡é€EEÂ€ã‚Eƒ¡ç¹ï½¼ç¹ï¿½ç¸ºE®è¬ŒåEæ£¡ç¹§å‘ˆæ€™èŸE§è›¹æ‚¶Â€ãƒ»/p>
               </div>
            </div>
            <button onClick={handleLogin} className="w-full bg-slate-900 text-white py-5 font-black text-lg shadow-xl flex items-center justify-center gap-4 hover:shadow-2xl transition-all rounded-[2rem]">
               ...
               Googleé¨¾E£è¬³Eºç¸ºE§ç¹ï½­ç¹§E°ç¹§E¤ç¹ï½³
            </button>
         </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-slate-50 pb-32 text-slate-900 font-sans selection:bg-blue-100 uppercase-none">
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-2xl border-b border-slate-100 px-6 py-4 flex items-center justify-between no-print shadow-sm">
        <div className="flex items-center gap-4">
           ...
           <div>
              <h1 className="text-xl font-black tracking-tight text-slate-900 leading-none">è³æº½E¸E¾é‚‚ï½¡é€EEãƒ»KPIèœ·æ¢§æ‚E¹§E·ç¹§E¹ç¹ãEÎE/h1>
           </div>
        </div>
        <div className="flex items-center gap-4">
           ...
           <div className="flex items-center gap-4">
              <div className="text-right hidden md:block">
                 ...
                 <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{userRole === 'admin' ? 'ç¹§E·ç¹§E¹ç¹ãEÎ’é‚‚E¡é€EEÂ€ãƒ» : 'ç¹åŠ±ÎŸç¹§E¸ç¹§E§ç¹§E¯ç¹åŒ»Î“ç¹ï½³ç¹èEãƒ»'}</div>
              </div>
      ...
      {(activeTab === 'dashboard' || activeTab === 'analytics' || activeTab === 'shifts' || activeTab === 'attendance' || activeTab === 'gas' || activeTab === 'settings') && (
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t-2 border-slate-100 flex items-center justify-between no-print pt-2 pb-6 px-4">
          <NavButton active={activeTab === 'dashboard'} onClick={() => setActiveTab('dashboard')} icon={I.Grid} label="ç¹å¸™ãEç¹ï¿½" />
          <NavButton active={activeTab === 'analytics'} onClick={() => setActiveTab('analytics')} icon={I.PieChart} label="è›»ãƒ»æ¢µ" />
          <NavButton active={activeTab === 'shifts'} onClick={() => setActiveTab('shifts')} icon={I.Calendar} label="ç¹§E·ç¹è¼”ãƒ¨" />
          <NavButton active={activeTab === 'attendance'} onClick={() => setActiveTab('attendance')} icon={I.Clock} label="è»E¥è±E½´/è¬ŒåEæ£¡" />
          <NavButton active={activeTab === 'gas'} onClick={() => setActiveTab('gas')} icon={I.Zap} label="GASé¨¾E£è¬³Eº" />
          <NavButton active={activeTab === 'settings'} onClick={() => setActiveTab('settings')} icon={I.Settings} label="éšªE­è³ãƒ» />
        </nav>
      )}
